...
public class ShooterConstants {
  ...
  //===============Safeties==================
  public static final int kHoodMaxUp = 0;
  public static final int kHoodMaxDown = 0;
  
  public static final int kTurretMaxClockwise = 0;
  public static final int kTurretMaxCounterClockwise = 0;
